...
public class RecordListNotesMonthAdapter extends BaseAdapter {
    ...
    public RecordListNotesMonthAdapter(Context context, int layout, ArrayList<HMAuxNotes> hmAux) {
        this.hmAux = hmAux;
...
//monta a listview
        ...
        holder.celula_ano_mes.setText(mesText);
        return row;
    }
